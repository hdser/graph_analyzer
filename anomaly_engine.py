...
Also includes CompositeMetricEngine for creating derived metrics.
"""
...
class AnomalyEngine:
    ...
    def _dbscan_detection(
        ...
        # For simplicity, use a score based on cluster membership
    ...
    def _mahalanobis_detection(
        ...
        p = X.shape[1]
        chi2_threshold = np.sqrt(stats.chi2.ppf(0.99, df=p))  # 99th percentile
